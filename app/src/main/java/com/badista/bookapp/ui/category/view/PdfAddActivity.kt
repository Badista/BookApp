...
import com.badista.bookapp.databinding.ActivityPdfAddBinding
...
class PdfAddActivity : AppCompatActivity() {
    ...
    private fun uploadPdfIntoDb(uploadedPdfurl: String, timestamp: Long) {
        // step 4
    ...
    private fun categoryPickDialog(){
        Log.d(TAG, "Category Pick Dialog: Showin PDF Category Pick Category")
